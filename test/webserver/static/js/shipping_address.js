...
$(function(){
	...
	$(".js-update-shipping-address").bind("click",function(){
		...
		clearAddress();
		$.ajax({
			url : shop_main + "/member/getmemberexpressaddress",
			type : "post",
			data : { "id" : id},
	...
	$(".js-shipping-address-remove").bind("click",function(){
		...
		$('.pop-sure').click(function(){
			$.ajax({
				url : shop_main + "/member/membersaddressdelete",
				type : "post",
				data : {"id" :id},
				success : function(res){
					$.msg(res.message);
	...
	$("#save_shipping_address").bind("click",function(){
		if(validationAddress()){
			...
			$.ajax({
				url : shop_main + "/member/operationaddress",
				type : "post",
				data : { 
					"id" : address_id,
					"consigner" : consigner,
	...
	$(".js-shipping-address li[class*='other-add']").bind("click",function(){
		...
		$.ajax({
			url : shop_main+"/member/updateaddressdefault",
			type : "post",
			data : {"id" : id},
